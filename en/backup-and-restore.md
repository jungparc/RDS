...
![db-instance-list-export-obs-en](https://static.toastoven.net/prod_rds/24.03.12/db-instance-list-export-obs-ko.png)

![db-instance-list-export-obs-modal-en](https://static.toastoven.net/prod_rds/24.03.12/db-instance-list-export-obs-modal-ko.png)
...
![snapshot-restoration-en](https://static.toastoven.net/prod_rds/24.03.12/snapshot-restoration-ko.png)
...
> [Caution]
> If the setting value of innodb_data_file_path is not ibdata1:12M:autoextend, it is unable to restore to DB instance of RDS for MySQL.
